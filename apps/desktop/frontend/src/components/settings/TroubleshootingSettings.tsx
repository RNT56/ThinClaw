    ...
    return (
        <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
                <div className="p-6 border border-border/50 rounded-xl bg-card space-y-4 font-mono text-sm shadow-xs">
                ...
                <div className="p-6 border border-border/50 rounded-xl bg-card space-y-4 shadow-xs">
            ...
            <div className="p-6 border border-rose-500/20 rounded-xl bg-card/50 space-y-4 shadow-xs">
