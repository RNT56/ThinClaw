...
export function ThinClawMemory() {
    ...
    const [searchResults, setSearchResults] = useState<thinclaw.MemorySearchResult[]>([]);
    ...
    const handleSemanticSearch = useCallback(async () => {
        ...
        setIsSearching(true);
        try {
            const resp = await thinclaw.searchMemory(search.trim(), 20);
