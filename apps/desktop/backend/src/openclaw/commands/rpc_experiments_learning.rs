...
//!
//! These IPC commands keep the alpha `openclaw_*` command names while routing
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_status(
    ironclaw: State<'_, IronClawState>,
    limit: Option<u32>,
) -> Result<Value, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_history(
    ironclaw: State<'_, IronClawState>,
    limit: Option<u32>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_candidates(
    ironclaw: State<'_, IronClawState>,
    limit: Option<u32>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_artifact_versions(
    ironclaw: State<'_, IronClawState>,
    limit: Option<u32>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_provider_health(
    ironclaw: State<'_, IronClawState>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_code_proposals(
    ironclaw: State<'_, IronClawState>,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_outcomes(
    ironclaw: State<'_, IronClawState>,
    status: Option<String>,
    limit: Option<u32>,
) -> Result<Value, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_rollbacks(
    ironclaw: State<'_, IronClawState>,
    limit: Option<u32>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_review_code_proposal(
    ironclaw: State<'_, IronClawState>,
    proposal_id: String,
    decision: String,
    note: Option<String>,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_review_outcome(
    ironclaw: State<'_, IronClawState>,
    outcome_id: String,
    decision: String,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_record_rollback(
    ironclaw: State<'_, IronClawState>,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_learning_evaluate_outcomes(
    ironclaw: State<'_, IronClawState>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
        return proxy
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_projects(
    ironclaw: State<'_, IronClawState>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_campaigns(
    ironclaw: State<'_, IronClawState>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_runners(
    ironclaw: State<'_, IronClawState>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_targets(
    ironclaw: State<'_, IronClawState>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_trials(
    ironclaw: State<'_, IronClawState>,
    campaign_id: String,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_trial_artifacts(
    ironclaw: State<'_, IronClawState>,
    trial_id: String,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_model_usage(
    ironclaw: State<'_, IronClawState>,
    limit: Option<u32>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_opportunities(
    ironclaw: State<'_, IronClawState>,
    limit: Option<u32>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_gpu_clouds(
    ironclaw: State<'_, IronClawState>,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
        return proxy
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_validate_runner(
    ironclaw: State<'_, IronClawState>,
    runner_id: String,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_campaign_action(
    ironclaw: State<'_, IronClawState>,
    campaign_id: String,
    action: String,
) -> Result<Value, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_gpu_validate(
    ironclaw: State<'_, IronClawState>,
    provider: String,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_experiments_gpu_launch_test(
    ironclaw: State<'_, IronClawState>,
    provider: String,
) -> Result<Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
