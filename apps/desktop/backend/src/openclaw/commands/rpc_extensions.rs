...
pub async fn openclaw_hooks_list(
    ...
    if ironclaw.remote_proxy().await.is_some() {
        return Err(RemoteGatewayProxy::unavailable(
            "hook listing",
            "the gateway has no lifecycle hook management endpoints",
        ));
    }
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_extension_install(
    ironclaw: State<'_, IronClawState>,
    name: String,
    url: Option<String>,
    kind: Option<String>,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_extension_registry_search(
    ironclaw: State<'_, IronClawState>,
    query: Option<String>,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_extension_reconnect(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<ExtensionActionResponse, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_extension_setup_get(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_extension_setup_submit(
    ironclaw: State<'_, IronClawState>,
    name: String,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_extension_validate_setup(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<ExtensionActionResponse, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_servers(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_server(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_server_tools(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_server_resources(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_read_resource(
    ironclaw: State<'_, IronClawState>,
    name: String,
    uri: String,
) -> Result<serde_json::Value, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_resource_templates(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_server_prompts(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_get_prompt(
    ironclaw: State<'_, IronClawState>,
    server_name: String,
    prompt_name: String,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_oauth(
    ironclaw: State<'_, IronClawState>,
    name: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_set_log_level(
    ironclaw: State<'_, IronClawState>,
    name: String,
    level: String,
) -> Result<ExtensionActionResponse, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_interactions(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_mcp_interaction_respond(
    ironclaw: State<'_, IronClawState>,
...
pub async fn openclaw_compact_session(
    ...
    if ironclaw.remote_proxy().await.is_some() {
        return Err(RemoteGatewayProxy::unavailable(
            "session compaction",
            "the gateway has no explicit compact-session endpoint",
        ));
    }
