...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_jobs_list(
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_jobs_summary(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_job_detail(
    ironclaw: State<'_, IronClawState>,
    job_id: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_job_cancel(
    ironclaw: State<'_, IronClawState>,
    job_id: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_job_restart(
    ironclaw: State<'_, IronClawState>,
    job_id: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_job_prompt(
    ironclaw: State<'_, IronClawState>,
    job_id: String,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_job_events(
    ironclaw: State<'_, IronClawState>,
    job_id: String,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_job_files_list(
    ironclaw: State<'_, IronClawState>,
    job_id: String,
    path: Option<String>,
) -> Result<serde_json::Value, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_job_file_read(
    ironclaw: State<'_, IronClawState>,
    job_id: String,
    path: String,
) -> Result<serde_json::Value, String> {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_status(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_bootstrap(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_pause(
    ironclaw: State<'_, IronClawState>,
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_resume(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_permissions(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_desktop_permission_status(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    openclaw_autonomy_permissions(ironclaw).await
}

#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_rollback(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_rollouts(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_checks(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
...
#[tauri::command]
#[specta::specta]
pub async fn openclaw_autonomy_evidence(
    ironclaw: State<'_, IronClawState>,
) -> Result<serde_json::Value, String> {
    if let Some(proxy) = ironclaw.remote_proxy().await {
