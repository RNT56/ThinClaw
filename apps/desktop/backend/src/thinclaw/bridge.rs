...
pub static ROUTE_TABLE: &[(&str, RouteMode)] = &[
    ...
    (
        "direct_runtime_deactivate_model_services",
        RouteMode::LocalOnly,
    ),
    (
    ...
    ("direct_runtime_discover_hf_models_v2", RouteMode::LocalOnly),
    ("direct_runtime_download_hf_selection", RouteMode::LocalOnly),
    ...
    ("direct_runtime_get_hf_capabilities", RouteMode::LocalOnly),
    ("direct_runtime_get_model_files_v2", RouteMode::LocalOnly),
    ("direct_runtime_get_sidecar_status", RouteMode::LocalOnly),
    ("direct_runtime_is_engine_ready", RouteMode::LocalOnly),
    ("direct_runtime_list_ollama_models", RouteMode::LocalOnly),
    ...
    ("get_mcp_sandbox_settings", RouteMode::LocalOnly),
    ...
    ("test_mcp_sandbox_connection", RouteMode::LocalOnly),
    ...
    ("thinclaw_canvas_panel_action", RouteMode::LocalOnly),
    ...
    ("thinclaw_copy_gateway_token", RouteMode::LocalOnly),
