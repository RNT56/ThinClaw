# ThinClaw Deploy Runbooks

Pick the runbook that matches the host or deployment shape you are actually
using.

| Situation | Start Here |
|---|---|
| macOS local, Mac Mini, or launchd service | [macos.md](macos.md) |
| Windows native install or WSL guidance | [windows.md](windows.md) |
