...
| coverage threshold (`--fail-under`, no `--lib`) | silent coverage erosion | 🟡 partial: CI enforces 53.2% plus 155,404 covered lines, dated steps to 60%, and 70% changed-line coverage; expanding the LCOV job beyond `--lib` remains |
