#!/usr/bin/env bash
# ============================================================================
# ThinClaw — Developer Setup Script
# ============================================================================
#
...
#   - wasm32-wasip2 Rust target (WASM compilation)
#   - wasm-tools (WASM component model conversion)
#   - cargo-component (WASM extension builder)
#
# Usage:
...
echo "  ✓ wasm32-wasip2 target"
echo "  ✓ wasm-tools $(wasm-tools --version 2>/dev/null | awk '{print $2}' || echo '')"
echo "  ✓ cargo-component"
echo ""
echo "Quick start:"
...
echo ""
echo "User installs:"
echo "  curl --proto '=https' --tlsv1.2 -LsSf https://github.com/RNT56/ThinClaw/releases/latest/download/thinclaw-installer.sh | sh"
echo "  curl --proto '=https' --tlsv1.2 -LsSf https://github.com/RNT56/ThinClaw/releases/latest/download/thinclaw-installer.sh | sh -s -- --profile edge"
echo ""
echo "Source builds for local patches:"
echo "  cargo build --release --bin thinclaw"
echo "  cargo build --release --features full --bin thinclaw"
echo ""
echo "One-click Mac deployment:"
echo "  ./scripts/mac-deploy.sh              # Release install"
echo "  ./scripts/mac-deploy.sh --from-source --bundled"
