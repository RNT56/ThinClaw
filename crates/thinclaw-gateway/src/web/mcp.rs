...
pub struct McpServerInfo {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stdio_isolation_mode: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stdio_network_allowed: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stdio_request_timeout_secs: Option<u64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stdio_migration_required: Option<bool>,
    pub enabled: bool,
    pub active: bool,
...
pub fn mcp_server_info(input: McpServerInfoInput) -> McpServerInfo {
    McpServerInfo {
        ...
        stdio_isolation_mode: input.stdio_isolation_mode,
        stdio_network_allowed: input.stdio_network_allowed,
        stdio_request_timeout_secs: input.stdio_request_timeout_secs,
        stdio_migration_required: input.stdio_migration_required,
...
mod tests {
    ...
    fn mcp_server_response_preserves_json_shape() {
        let response = mcp_server_list_response(vec![mcp_server_info(McpServerInfoInput {
            ...
            stdio_isolation_mode: Some("strict".to_string()),
            stdio_network_allowed: Some(false),
            stdio_request_timeout_secs: Some(120),
            stdio_migration_required: Some(false),
            enabled: true,
            active: true,
            authenticated: true,
            requires_auth: false,
        ...
        assert_eq!(
            ...
            serde_json::json!({
                "servers": [{
                    ...
                    "transport": "stdio",
                    "command": "fs-mcp",
                    "stdio_isolation_mode": "strict",
                    "stdio_network_allowed": false,
                    "stdio_request_timeout_secs": 120,
                    "stdio_migration_required": false,
                    "enabled": true,
                    "active": true,
                    "authenticated": true,
                    "requires_auth": false,
