...
use crate::helpers::{optional_env, parse_optional_env, synced_oauth_env};
use thinclaw_settings::{ProviderCredentialMode, Settings};
...
mod tests {
    ...
    fn clear_openai_compatible_env() {
        crate::helpers::clear_bridge_vars();
        crate::helpers::clear_injected_vars_for_tests();
