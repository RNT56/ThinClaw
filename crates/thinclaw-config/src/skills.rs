...
use thinclaw_settings::{Settings, SkillTapConfig, WellKnownSkillRegistryConfig};
...
pub struct SkillsConfig {
    ...
    pub enabled: bool,
    /// Directory containing user-placed skills.
    pub local_dir: PathBuf,
    /// Directory containing registry-installed skills.
...
fn default_skills_dir() -> PathBuf {
    thinclaw_platform::state_paths().skills_dir
}

fn default_installed_skills_dir() -> PathBuf {
    thinclaw_platform::state_paths().installed_skills_dir
}

fn default_quarantine_dir() -> PathBuf {
    thinclaw_platform::resolve_data_dir("skills_quarantine")
}
