...
fn default_patterns() -> Vec<LeakPattern> {
    vec![
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"sk-(?:proj-)?[a-zA-Z0-9]{20,}(?:T3BlbkFJ[a-zA-Z0-9_-]*)?")
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"sk-ant-api[a-zA-Z0-9_-]{90,}")
                .expect("constant regex pattern must compile"),
            severity: LeakSeverity::Critical,
            action: LeakAction::Block,
        },
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"AKIA[0-9A-Z]{16}").expect("constant regex pattern must compile"),
            severity: LeakSeverity::Critical,
            action: LeakAction::Block,
        },
        // GitHub tokens
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"github_pat_[a-zA-Z0-9]{22}_[a-zA-Z0-9]{59}")
                .expect("constant regex pattern must compile"),
            severity: LeakSeverity::Critical,
            action: LeakAction::Block,
        },
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"sk_(?:live|test)_[a-zA-Z0-9]{24,}")
                .expect("constant regex pattern must compile"),
            severity: LeakSeverity::Critical,
            action: LeakAction::Block,
        },
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"sess_[a-zA-Z0-9]{32,}")
                .expect("constant regex pattern must compile"),
            severity: LeakSeverity::Critical,
            action: LeakAction::Block,
        },
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"xox[baprs]-[0-9a-zA-Z-]{10,}")
                .expect("constant regex pattern must compile"),
            severity: LeakSeverity::High,
            action: LeakAction::Block,
        },
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"SK[a-fA-F0-9]{32}").expect("constant regex pattern must compile"),
            severity: LeakSeverity::High,
            action: LeakAction::Block,
        },
        // SendGrid API keys
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"Bearer\s+[a-zA-Z0-9_-]{20,}")
                .expect("constant regex pattern must compile"),
            severity: LeakSeverity::High,
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"(?i)authorization:\s*[a-zA-Z]+\s+[a-zA-Z0-9_-]{20,}")
                .expect("constant regex pattern must compile"),
            severity: LeakSeverity::High,
            action: LeakAction::Redact,
        },
        ...
        LeakPattern {
            ...
            regex: Regex::new(r"\b[a-fA-F0-9]{64}\b").expect("constant regex pattern must compile"),
