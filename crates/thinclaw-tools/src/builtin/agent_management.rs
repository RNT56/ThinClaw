...
use thinclaw_types::{JobContext, ToolProfile};
...
pub struct CreateAgentTool {
    registry: Arc<dyn AgentManagementPort>,
}

impl CreateAgentTool {
    pub fn new(registry: Arc<dyn AgentManagementPort>) -> Self {
        Self { registry }
    }
}
