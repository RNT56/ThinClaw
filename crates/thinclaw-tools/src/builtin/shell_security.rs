...
pub static NEVER_AUTO_APPROVE_PATTERNS: LazyLock<Vec<&'static str>> = LazyLock::new(|| {
    vec![
        "rm -rf",
        "rm -fr",
        "chmod -r 777",
...
pub fn extract_binary_name(cmd: &str) -> Option<String> {
...
/// against "| sh".
pub fn contains_shell_pipe(lower: &str) -> bool {
...
/// "host ".
pub fn has_command_token(lower: &str, token: &str) -> bool {
