...
// Runtime-descriptor DTOs/builders moved to `thinclaw-tools-core`; re-exported
// here for path stability (`thinclaw_tools::execution::*`).
pub use thinclaw_tools_core::execution_descriptor::*;
