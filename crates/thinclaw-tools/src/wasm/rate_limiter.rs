...
//!
//! The base rate limiter implementation lives in `thinclaw_tools_core::rate_limiter`.
...
// continue to work via `thinclaw_tools::wasm::rate_limiter::*`.
pub use thinclaw_tools_core::rate_limiter::{
    LimitType, RateLimitError, RateLimitResult, RateLimiter,
};
