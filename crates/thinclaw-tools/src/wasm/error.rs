...
impl From<WasmError> for thinclaw_tools_core::ToolError {
    fn from(e: WasmError) -> Self {
        thinclaw_tools_core::ToolError::Sandbox(e.to_string())
    }
}
...
#[cfg(test)]
mod tests {
    use crate::wasm::error::{TrapCode, TrapInfo, WasmError};
    ...
    fn test_conversion_to_tool_error() {
        ...
        let tool_err: thinclaw_tools_core::ToolError = wasm_err.into();
        match tool_err {
            thinclaw_tools_core::ToolError::Sandbox(msg) => {
