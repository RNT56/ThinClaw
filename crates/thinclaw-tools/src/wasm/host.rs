...
impl HostState {
    ...
    pub fn check_http_allowed(&self, url: &str, method: &str) -> Result<(), String> {
        ...
        use crate::wasm::allowlist::AllowlistValidator;
...
mod tests {
    ...
    fn test_http_request_rate_limit() {
        ...
        let capabilities = Capabilities {
            http: Some(crate::wasm::capabilities::HttpCapability::default()),
            ..Default::default()
        };
    ...
    fn test_tool_invoke_rate_limit() {
        ...
        let capabilities = Capabilities {
            tool_invoke: Some(crate::wasm::capabilities::ToolInvokeCapability::default()),
            ..Default::default()
        };
        let mut state = HostState::new(capabilities);
