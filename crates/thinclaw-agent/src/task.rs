...
//!
//! Tasks are the unit of work that can be scheduled for execution. They can
//! represent full LLM-driven jobs, parallel tool batches, or background
//! computations.
...
use thinclaw_types::error::WorkerError;
use uuid::Uuid;
...
pub trait TaskHandler: Send + Sync {
    ...
    async fn run(&self, ctx: TaskContext) -> Result<TaskOutput, WorkerError>;
