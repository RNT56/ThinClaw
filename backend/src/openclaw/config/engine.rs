...
//! load_config(), and env_vars() methods for OpenClawConfig.
...
impl OpenClawConfig {
    ...
    pub fn write_config(
        ...
        // by the Node.js OpenClaw engine gateway (replaced by IronClaw in-process).
    ...
    pub fn env_vars(&self) -> Vec<(String, String)> {
        ...
        // NOTE: base_dir_str removed — OPENCLAW_HOME is no longer set (see comment below)
        ...
        let mut vars = vec![
            ...
            // NOTE: Do NOT set OPENCLAW_HOME here. The engine uses OPENCLAW_HOME as a
            // user home-directory override and appends "/.openclaw" to derive the state dir.
            // Setting it to the AppData base dir would cause the engine to look in
            // AppData/OpenClaw/.openclaw — a wrong path. Instead we use OPENCLAW_STATE_DIR
            // and OPENCLAW_CONFIG_PATH to point directly at the correct locations.
