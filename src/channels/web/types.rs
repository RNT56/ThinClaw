...
pub use thinclaw_gateway::web::types::{
    ...
    ExperimentsQuery, ExtensionActivateRequest, ExtensionInfo, ExtensionListResponse,
    ExtensionSetupRequest, ExtensionSetupResponse, FilePathQuery, GatewayStatusResponse,
    HealthResponse, HistoryQuery, HistoryResponse, HookInfo, HookListResponse, HookRegisterRequest,
    HookRegisterResponse, HookUnregisterResponse, InstallExtensionRequest, JobDetailResponse,
    JobEventsQuery, JobInfo, JobListQuery, JobListResponse, JobSummaryResponse, ListEntry,
    ListQuery, LogLevelRequest, LogLevelResponse, LogsRecentResponse, MemoryAccessScope,
