//! Loadable CLI skin definitions for the TUI and REPL.
//!
//! ThinClaw uses a small skin layer so local clients can share the same
//! palette and prompt affordances without hardcoding colors in each renderer.
...
/// Runtime CLI skin used by the TUI and REPL.
#[derive(Debug, Clone)]
pub struct CliSkin {
    pub name: String,
