...
export function ClawdbotSystemControl() {
    ...
    const fetchData = async () => {
        try {
            const [s, c, sc] = await Promise.all([
                ...
                clawdbot.getClawdbotConfig(),
                clawdbot.getClawdbotConfigSchema()
            ]);
            setStatus(s);
            if (c) {
    ...
    const fetchLogs = async () => {
        try {
            const data = await clawdbot.getClawdbotLogsTail(100);
    ...
    const handleSaveConfig = async () => {
        ...
        try {
            ...
            const c = await clawdbot.getClawdbotConfig();
    ...
    const handleUpdate = async () => {
        toast.promise(clawdbot.runClawdbotUpdate(), {
