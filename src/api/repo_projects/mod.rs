...
mod views;
use views::*;
// Part of this module public API (external callers use the
// repo_projects_api::default_user_id path); re-export it past the split.
pub use views::default_user_id;
