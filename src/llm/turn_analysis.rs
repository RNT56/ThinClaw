...
pub(crate) struct ToolOutcomeDigest {
    pub name: String,
    pub content: String,
    pub is_error: bool,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct AssistantToolPlanDigest {
    pub content: String,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct TurnAwareness {
...
impl TurnAwareness {
    ...
    pub(crate) fn complexity_probe_text(&self) -> String {
    ...
    pub(crate) fn context_snapshot(&self, tool_results_seen: Option<u32>) -> String {
    ...
    pub(crate) fn is_complex_or_planning_turn(&self) -> bool {
...
fn summarize_tool_calls(tool_calls: &[crate::llm::ToolCall]) -> String {
    tool_calls
        .iter()
        .map(|tool_call| {
