//! Psychographic profile types for user personalization.
//!
//! Captures personality traits, communication preferences, behavioral patterns,
//! and assistance preferences discovered during the onboarding conversation
//! and refined through ongoing interactions (weekly evolution).
//!
...
///
/// Shared by bootstrap onboarding and profile evolution prompt generation
/// to ensure the LLM always targets the same structure.
...
// ---------------------------------------------------------------------------
// Relationship values, interaction preferences, analysis metadata
// ---------------------------------------------------------------------------
