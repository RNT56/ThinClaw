...
export const commands = {
    ...
    async ttsSynthesize({ text, modelPath }: { text: string; modelPath: string | null }): Promise<Result<string, string>> {
        try {
...
// Note: TAURI_CHANNEL is defined below as the real import from @tauri-apps/api/core
/**
...
// @ts-expect-error — tauri-specta generates this helper for event subscriptions; unused when no events are registered
