                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-border/40 bg-white/[0.02]">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] text-muted-foreground">Stored in IronClaw RoutineStore — survives restarts</p>
                        </div>
                    </div>
            ...
            <div className="p-6 rounded-2xl border bg-amber-500/5 border-amber-500/10 flex gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
                        ...
                        Jobs created here are stored in IronClaw's RoutineStore and survive engine restarts.
                    </p>
                </div>
            </div>
