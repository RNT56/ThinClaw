...
export function OpenClawDoctor() {
    const [diagnostics, setDiagnostics] = useState<openclawApi.DiagnosticsResponse | null>(null);
    ...
    const runDiagnostics = useCallback(async () => {
        setLoading(true);
        try {
            const resp = await openclawApi.runDiagnostics();
            setDiagnostics(resp);
            setLastRun(new Date());
        } catch (e) {
