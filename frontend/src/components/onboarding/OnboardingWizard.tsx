...
export function OnboardingWizard({ onComplete }: OnboardingWizardProps) {
    ...
    const handleRemoteDeploy = async () => {
        ...
        setRemoteDeployLogs(['=== IronClaw Remote Deploy ===', `Target: ${remoteUser}@${remoteIp}`]);
        setRemoteError('');
        try {
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground mt-1">
                                                Deploy or connect to a remote IronClaw server. Ideal for lighter devices.
                                            </p>
                                        </div>
                                    </button>
                                </div>
                                ...
                                {remoteDeployMode === 'existing' ? (
                                    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                                        <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 text-sm text-emerald-600 dark:text-emerald-400">
                                            ...
                                            <p className="opacity-90 text-xs font-medium">Connect to an already running IronClaw HTTP gateway.</p>
                                        </div>
