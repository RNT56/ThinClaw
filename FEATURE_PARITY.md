...
> B1→B3): the whole app + widget + NSE + watch embeds build for the iOS 26 /
> watchOS 26 simulators, gateway backends are Rust-tested, and Swift logic is
