...
> **Last reconciled:** 2026-07-02 (agent-loop hardening: dispatcher transient retry, credential-aware failover, compaction summary re-injection, model-derived context window, routine failure backoff/auto-disable, two-phase subagent cancellation)
