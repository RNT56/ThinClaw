...
| Native channels | Signal, Discord, Matrix, Nostr, Gmail, iMessage, BlueBubbles, Linq managed messaging, Apple Mail, voice-call, APNs, browser-push (Telegram and Slack are WASM packages) | [docs/CHANNEL_ARCHITECTURE.md](docs/CHANNEL_ARCHITECTURE.md) |
...
| Managed iMessage/RCS/SMS via Linq | Supported | Supported | Supported |
