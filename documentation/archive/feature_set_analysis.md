...
> [!WARNING]
> **📦 ARCHIVED — Historical Snapshot (Pre-IronClaw Era)**
>
> This analysis was generated on 2026-02-17 against the **old Node.js/WebSocket bridge architecture**.
> Major changes since then:
> - `openclaw/ws_client.rs`, `normalizer.rs`, `frames.rs`, `ipc.rs` — **all deleted**
> - `openclaw/commands.rs` (103KB monolith) — **split** into `rpc.rs`, `sessions.rs`, `keys.rs`, `gateway.rs`
> - IronClaw is now **in-process Rust library** — no Node.js sidecar
> - Integration tests exist (`cloud/integration_tests.rs`, 22KB)
> - Multi-engine inference system implemented (`backend/src/engine/`)
> - Cloud storage (8 providers) implemented (`backend/src/cloud/providers/`)
>
> For current architecture, see:
> - `documentation/scrappy_documentation_canonical.md`
> - `documentation/latest/MICROSERVICES_AND_SIDECARS.md`
> - `documentation/latest/SUBAGENT_SYSTEMS.md`
