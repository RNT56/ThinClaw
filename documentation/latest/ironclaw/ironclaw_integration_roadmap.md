...
> **✅ COMPLETED (2026-03)**
>
> All phases of this roadmap have been executed. This document is retained as **historical reference**.
> - All new files created (`ironclaw_bridge.rs`, `ironclaw_channel.rs`, `sanitizer.rs`, `ui_types.rs`)
> - All dead code deleted (`ws_client.rs`, `normalizer.rs`, `frames.rs`, `ipc.rs`)
> - All 66 commands migrated from WS RPC → direct IronClaw API calls
> - Node.js sidecar eliminated (~625 MB recovered)
>
> See `tauri_dropin_spec.md` for detailed phase-by-phase completion log.
