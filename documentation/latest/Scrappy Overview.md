...
4. **A cloud-connected brain** — with 14 cloud LLM providers and 7 cloud storage backends
...
| **Cloud Storage** | `cloud/` (21 files) | 7 providers (S3, GCS, Azure, B2, R2, MinIO, Storj) with AES encryption |
