...
│
└── lib/
    ├── bindings.ts            # Auto-generated Tauri command types (58 KB)
...
All Rust `#[command]` signatures as TypeScript. Never edit by hand — regenerated by `tauri-specta`. The `commands` object is the typed invoke wrapper:
```ts
