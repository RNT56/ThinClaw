...
| What | File | Location |
|---|---|---|
| Preamble, Safety, Tooling section | `ironclaw/src/llm/reasoning.rs` | `build_conversation_prompt()` ~L980 |
| Desktop Capabilities (sandboxed) | `ironclaw/src/llm/reasoning.rs` | `build_workspace_capabilities_section()` ~L1074 |
| Desktop Capabilities (project) | `ironclaw/src/llm/reasoning.rs` | `build_workspace_capabilities_section()` ~L1090 |
| Desktop Capabilities (unrestricted) | `ironclaw/src/llm/reasoning.rs` | `build_workspace_capabilities_section()` ~L1100 |
| Channel formatting (Discord/Telegram etc.) | `ironclaw/src/llm/reasoning.rs` | `build_channel_section()` ~L1112 |
| Group chat rules | `ironclaw/src/llm/reasoning.rs` | `build_group_section()` ~L1155 |
