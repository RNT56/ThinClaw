...
- **Saving a key does NOT automatically grant it** to the IronClaw agent. After saving, you must toggle **"Grant Access"** for each key in Settings › Secrets. This ensures keys are only exposed to the agent when you explicitly permit it.
