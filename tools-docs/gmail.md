...
Authenticating once with any installed Google tool gives the shared `google_oauth_token` to the other Google tools too. Re-running `thinclaw extensions tools auth <google-tool>` later upgrades the shared scopes when needed.
